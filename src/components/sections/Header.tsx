...
> = {
    ...
    // ====================================================================
    // OLD 'WHO WE CREATE FOR' DATA (disabled — kept for reference)
    // ====================================================================
    /* whoWeCreateFor_OLD: {
    ...
    // ====================================================================
    // NEW 'WHO WE CREATE FOR' MEGA MENU DATA
    // Left column: Core Industries (link to industry pages)
    // Right column: Selected Case Studies (link to case study pages)
    // Same layout logic as 'What We Do'
    // ====================================================================
    whoWeCreateFor: {
        title: "Who We Create For",
        sections: [
            ...
            },
            {
                ...
                href: "/who-we-create-for/education-elearning",
                subcategories: [
                    {
    ...
    return (
        <header className="sticky top-0 z-50 w-full bg-white">
            ...
            >
                            ...
                            {navItems.map((item) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        className={`group text-[14px] font-medium transition-colors relative ${isActive
                                            ? "text-gray-900"
                                    ...
                                    >
                                        ...
                                        {hasMega && (
                                            <span
                                                className={`pointer-events-none absolute left-0 -bottom-1 h-[2px] rounded-full transition-all duration-200 ${isActive
                                                    ? "w-full bg-[#6F00FF]"
                ...
                {currentMega && (
                    <div className="hidden md:block absolute inset-x-0 top-full bg-white border-t border-gray-100 shadow-lg">
                        <div className="max-w-7xl mx-auto px-10 py-8">
                            ...
                            {(activeMega === "whatWeDo" || activeMega === "whoWeCreateFor") && currentSections ? (
                                <div className="flex items-stretch gap-10">
                                    {/* LEFT COLUMN: BOLD MAIN CATEGORIES */}
                                    <div className="w-64 flex-shrink-0 pr-4">
                                        <h3 className="text-sm font-semibold uppercase text-gray-400 mb-2">
                                            {activeMega === "whoWeCreateFor" ? "Core Industries" : "Core Services"}
                                        </h3>
                                            ...
                                            {currentSections.map((section, idx) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`w-full text-left text-base font-bold py-3 px-4 rounded-md transition-all ${isSelected
                                    ...
                                    <div className="flex-1 pl-6">
                                        <h3 className="text-sm font-semibold uppercase text-gray-400 mb-2">
                                            {activeMega === "whoWeCreateFor" ? "Selected Case Studies" : "Subcategories"}
                                        </h3>
                ...
                <div
                    className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out bg-white w-full absolute ${mobileOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0"
                        }`}
                >
