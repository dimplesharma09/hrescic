...
const MarketingBlogCart = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-10">
      {/* Top Title */}
      <div className="mb-10">
        <h2 className="text-[2xl] md:text-[38px] font-serif text-[#555555] mb-2">
          Not another generic marketing blog.
        </h2>
        <p className="text-[#555] text-[16px] md:text-[20px] font-normal">
          Just clear explanations, sharp ideas and useful frameworks  — <br></br> written to
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="bg-[#300060] text-white p-10 rounded-xl flex flex-col justify-between">
          ...
          <div>
          <button className="mt-8 border text-[16px] px-6 py-2 w-64 rounded-full border-[#834CF680] hover:opacity-90 bg-[#3D0377] transition">
        ...
        <div className="bg-[#300060] text-white p-10 rounded-xl flex flex-col justify-between">
         ...
         <div>
            <button className="mt-8 border text-[16px] px-6 py-2  rounded-full border-[#834CF680] hover:opacity-90 bg-[#3D0377] transition">
